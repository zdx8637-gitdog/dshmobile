...
var labelStyle = { fontSize: 12, color: "#8b8e98", marginBottom: 4 };
var inputStyle = {
  width: "100%",
...
function DshmobileCard(props) {
  const snap = props.useDshmobileCard((s) => s);
  ...
  React.useEffect(() => {
    if (canvasRef.current) {
      ...
      let url = "";
      if (code) {
        url = mode === "grant" ? `${relay}/dshmobile/?mode=grant&code=${encodeURIComponent(code)}&pid=${encodeURIComponent(value.grantPairingId ?? "")}` : `${relay}/dshmobile/?mode=pair&code=${encodeURIComponent(code)}`;
      }
  ...
  React.useEffect(() => {
    ...
    const tick = () => {
      const ms = new Date(value.pairingExpiresAt).getTime() - Date.now();
      setLeft(Math.max(0, Math.round(ms / 1e3)));
    };
    tick();
    const t = setInterval(tick, 1e3);
    return () => clearInterval(t);
  }, [value.pairingExpiresAt]);
  const edit = (k, v) => setForm((f) => ({
    relayUrl: value?.relayUrl ?? "",
    username: value?.username ?? "",
    password: value?.password ?? "",
    deviceLabel: value?.deviceLabel ?? "",
  ...
  const register = async () => {
    ...
    const p = form?.password ?? value?.password ?? "";
    if (u.length < 3) {
      setLocalError("\u8D26\u53F7\u81F3\u5C11 3 \u4E2A\u5B57\u7B26\uFF08\u5B57\u6BCD/\u6570\u5B57/\u4E0B\u5212\u7EBF/\u6A2A\u7EBF\uFF09");
      return;
    }
    if (p.length < 6) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 12, padding: "14px 0" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 15, fontWeight: 600, color: "#e6e7ea" }, children: "DSH Mobile \u8FDC\u7A0B\u6865\u63A5" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "span",
        {
          style: {
            fontSize: 11,
            color: value?.bridgeStatus === "running" ? "#4ade80" : "#8b8e98",
            background: "#1c1e24",
            borderRadius: 999,
            padding: "2px 10px"
          },
          children: [
            "\u6865\u72B6\u6001\uFF1A",
            value?.bridgeStatus ?? "unknown"
          ]
        }
      ),
      value?.username ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "span",
          {
            style: {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: 0, fontSize: 12, color: "#8b8e98" }, children: "\u8BA9\u624B\u673A\u8FDC\u7A0B\u63A7\u5236\u672C\u673A DeepSeek Harness\uFF1A\u586B\u5199 relay \u8D26\u53F7\u540E\u4FDD\u5B58\uFF0C\u6865\u81EA\u52A8\u542F\u52A8\uFF1B\u624B\u673A App \u626B\u7801\u5373\u53EF\u767B\u5F55\u540C\u4E00\u8D26\u53F7\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: labelStyle, children: "relay \u5730\u5740" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { style: inputStyle, value: form?.relayUrl ?? value?.relayUrl ?? "", onChange: (e) => edit("relayUrl", e.target.value) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: labelStyle, children: "\u8D26\u53F7" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { style: inputStyle, value: form?.username ?? value?.username ?? "", onChange: (e) => edit("username", e.target.value) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: labelStyle, children: "\u5BC6\u7801" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { style: inputStyle, type: "password", value: form?.password ?? value?.password ?? "", onChange: (e) => edit("password", e.target.value) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: labelStyle, children: "\u8BBE\u5907\u540D\uFF08\u624B\u673A\u7AEF\u663E\u793A\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { style: inputStyle, value: form?.deviceLabel ?? value?.deviceLabel ?? "", onChange: (e) => edit("deviceLabel", e.target.value) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 10, alignItems: "center" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: btnStyle, onClick: save, children: "\u4FDD\u5B58\u5E76\u8FDE\u63A5\uFF08\u5DF2\u6709\u8D26\u53F7\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
      ...
      value?.registerError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12, color: "#f87171" }, children: value.registerError }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: 0, fontSize: 11, color: "#8b8e98" }, children: "\u5DF2\u6709\u8D26\u53F7\u586B\u597D\u70B9\u5DE6\u8FB9\uFF1B\u6CA1\u6709\u8D26\u53F7\u70B9\u53F3\u8FB9\u81EA\u52A8\u6CE8\u518C\uFF08\u22653 \u5B57\u7B26 + \u5BC6\u7801 \u22656 \u4F4D\uFF09\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { borderTop: "1px solid #23252b", margin: "4px 0" } }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 14, alignItems: "center" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("canvas", { ref: canvasRef, width: 132, height: 132, style: { border: "1px solid #2a2c33", borderRadius: 8 } }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 20, fontWeight: 700, letterSpacing: 5, color: "#e6e7ea" }, children: value?.pairingCode || "------" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "#8b8e98" }, children: value?.mode === "grant" ? left > 0 ? `\u7B49\u5F85\u624B\u673A\u6388\u6743\uFF08\u5269\u4F59 ${left} \u79D2\uFF09\u2014\u2014\u624B\u673A App \u5DF2\u767B\u5F55\u65F6\u626B\u7801\u5373\u6388\u6743\u672C\u673A` : "\u70B9\u51FB\u53F3\u4FA7\u6309\u94AE\u751F\u6210\u6388\u6743\u4E8C\u7EF4\u7801" : left < 0 ? "\u70B9\u51FB\u53F3\u4FA7\u6309\u94AE\u751F\u6210\u767B\u5F55\u4E8C\u7EF4\u7801" : left > 0 ? `\u5269\u4F59 ${left} \u79D2` : "\u5DF2\u8FC7\u671F\uFF0C\u8BF7\u91CD\u65B0\u751F\u6210" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: btnStyle, onClick: genPairing, children: "\u5237\u65B0\u4E8C\u7EF4\u7801" }),
        value?.pairError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12, color: "#f87171" }, children: value.pairError }) : null
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: 0, fontSize: 12, color: "#8b8e98" }, children: "\u624B\u673A\u5B89\u88C5 DSH Mobile App \u540E\uFF0C\u626B\u63CF\u4E8C\u7EF4\u7801\u6216\u8F93\u5165\u914D\u5BF9\u7801\u5373\u53EF\u767B\u5F55\u540C\u4E00\u8D26\u53F7\uFF08\u65E0\u9700\u5BC6\u7801\uFF09\u3002" })
  ] });
}
function apply(ctx) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        style: {
          ...
          fontSize: 13,
          padding: "4px 8px",
          width: wide ? "auto" : void 0
        },
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, transform: open ? "rotate(180deg)" : "none", display: "inline-block" }, children: "\u25B6" }),
          wide ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "DSH Mobile" }) : null
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DshmobileCard, { ...props })
      }
    ) : null
  ] });
}
